...
exports.thankyou_gateway = function(req,res){
  ...
  payumoney.setKeys('67RHZYFV','UXzy2PXnM6','MGwcLnST3HjFpT5ukZzjMo8t3CQrFbzK6KHxsqOn+MA=');
...
// });
  ...
  var transporter = nodemailer.createTransport({
    host: 'smtp.gmail.com',
        ...
        auth: {
            user: 'eckovationridima@gmail.com', // generated ethereal user
            pass: 'eckovationridima123'// generated ethereal password
        }
});

var mailOptions = {
  from: 'eckovationridima@gmail.com',
  to: req.body.email,
